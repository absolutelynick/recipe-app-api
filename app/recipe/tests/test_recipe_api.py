...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        # Many equals true so that we are returned a list
    ...
    def test_full_update_recipe(self):
        """Test updating a full recipe with a put. """
        recipe = sample_recipe(self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Fish Bugaloo')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title="Chicken Carbonara")
